...
public class b_LoginActivity extends Activity implements View.OnClickListener {
  ...
  public void onClick(View arg0) {
    if (arg0 == findViewById(R.id.editloginButton)) {
        ...
        //...
        EditText loginname_aux = findViewById(R.id.textToFillLogin);
        String loginname = loginname_aux.getText().toString();
        EditText passname_aux = findViewById(R.id.textToFillPassword);
  ...
  Handler handler = new Handler() {
    ...
    public void handleMessage(Message msg) {
      ...
      if (userInfo.getId() >= 0) {
        ...
        Intent int_aux = new Intent(b_LoginActivity.this,d_UsersListActivity.class);
